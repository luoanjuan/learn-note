...
public class AdivceTest {
   ...
   @Pointcut("execution(* daily.proxy.annotionProxy.TargetTest.*(..))")
    public void pointCut(){    }

    @Around("execution(* daily.proxy.annotionProxy.TargetTestInterface.methodOne(..))")
    ...
    @Around("target(daily.proxy.annotionProxy.TargetTestSub)")
...
//    @Around("target(daily.proxy.annotionProxy.TargetTest) && args(parameter)")
